...
const Tab1: React.FC = () => {
  ...
  const dataURL = "https://dev-cs55-13-2023.pantheonsite.io/wp-json/twentytwentyone-child/v1/movies";
        ...
        <IonList id="movie-list">
          ...
          {dataset.map((item, index) => (
            <IonItem lines="inset" key={index}>
              <IonLabel>
                <img src={item.guid} height="150px" width="100px" />
               <h2>Title: {item.movie_name}</h2>
                <h2>Gnere: {item.genre}</h2>
